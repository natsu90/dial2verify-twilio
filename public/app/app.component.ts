...
@Component({
    ...
    template: `<form class="pure-form">
	            ...
	            <div class="pure-u-1 pure-u-md-1-1">
	                <input (keyup.enter)="verifyNumber()" class="pure-u-23-24" [ngClass]="{'shake-hard shake-constant': isError}" type="text" placeholder="Phone number to verify" style="font-size:48px" [(ngModel)]="number">
	            </div>
	            </div>
	        </form>
	        <p>
